...
public class Xslt_XlsReader {

	LoadProperty loadProperty = new LoadProperty();
	String currentEnv = (String) loadProperty.getProperty("project.env");
	public String path = System.getProperty("user.dir")+"/src/config/" + "stag" +"/Testdata.xls";
	/*public String path;*/
	...
	/*public Xls_Reader(String path) {*/
		...
		/*this.path=path;*/
		public Xslt_XlsReader(String path) {
		try {
	...
	public static void main(String args[]) throws IOException{
		...
		try{
			...
			Xslt_XlsReader datatable = null;


			//datatable = new Xslt_XlsReader("D:\\AutomationRequests.xls");
