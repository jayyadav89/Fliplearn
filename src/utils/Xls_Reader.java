...
public class Xls_Reader {
	...
	//String filename = System.getProperty("user.dir").split("FlipLearn")[0].trim()+"/config/" + currentEnv +"/B2CResultss.xls";
	String filename = System.getProperty("user.dir").split("FlipLearn")[0].trim()+"/config/" + currentEnv +"/Testdata.xls";
	...
	/*public Xls_Reader(String path) {*/
		...
		public Xls_Reader() {
			...
			LoadProperty loadProperty = new LoadProperty();
			filename = (String) loadProperty.getProperty("datapath");
